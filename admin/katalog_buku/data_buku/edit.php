    ...
    <div class="form">
        <form action="" method="post">
            ...
            <div>
                ...
                <input type="text" name="thn_terbit"  value="<?= $data_buku["thn_terbit"] ?>">
            </div>

            <div>
                <label>Buku Baik</label>
                <input type="number" name="jmlh_baik"  value="<?= $data_buku["jmlh_baik"] ?>">
            </div>

            <div>
                <label>Buku Rusak</label>
                <input type="number" name="jmlh_rusak"  value="<?= $data_buku["jmlh_rusak"] ?>">
            </div>
